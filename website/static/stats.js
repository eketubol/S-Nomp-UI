...
var defaultPool = getDefaultPool(); // Default Pool ID

function removeLocalStorage(){
	localStorage.removeItem('defaultPool') || "";
}
function getDefaultPool() {
  var defaultPool = localStorage.getItem('defaultPool') || "";
  return defaultPool;
}

function setDefaultPool(pool) {
  localStorage.setItem("defaultPool", pool);
}
